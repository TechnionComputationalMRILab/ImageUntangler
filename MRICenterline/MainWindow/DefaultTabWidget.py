...
class DefaultTabWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.preferences_button.setMinimumSize(400, 200)
        self._grid_layout.addWidget(self.preferences_button, 2, 1, 1, 1)

        self.add_mri_images_button = QPushButton("Add MRI Images")
        self.add_mri_images_button.setMinimumSize(400, 200)
