...
from PyQt5.QtWidgets import QCheckBox, QWidget, QHBoxLayout, QLabel
...
class _AnimatedToggle(QCheckBox):
    # adapted from https://www.pythonguis.com/tutorials/qpropertyanimation/
